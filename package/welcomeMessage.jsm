...
<p>Autocrypt for Thunderbird was successfully configured!</p>

<p>We set up everything to get you started, no further configuration is
necessary.</p>
<p>Just two things:</p>
<ul>
  <li>Encryption is automatically available for all contacts with Autocrypt-compatible clients.</li>
  <li>If you already have some keys and want to import them, check out the Autocrypt settings.</li>
</ul>
<p>
  While writing messages, just click this button:
...
<p> - Alice, the Autocrypt bot</p>

<p>PS: This message was generated locally by the Autocrypt extension.</p>
`.replace(/\n/gm, '\r\n');
