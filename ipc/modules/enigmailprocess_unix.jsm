...
var {
  ...
  BaseProcess,
  PromiseWorker
} = ChromeUtils.import("chrome://autocrypt/content/modules/enigmailprocess_common.jsm", this);

Services.scriptloader.loadSubScript("chrome://autocrypt/content/modules/enigmailprocess_shared.js", this);
Services.scriptloader.loadSubScript("chrome://autocrypt/content/modules/enigmailprocess_shared_unix.js", this);
...
class Process extends BaseProcess {
  static get WORKER_URL() {
    return "chrome://autocrypt/content/modules/enigmailprocess_worker_unix.js";
  }
