...
var SubprocessConstants = ChromeUtils.import("chrome://autocrypt/content/modules/enigmailprocess_common.jsm").SubprocessConstants;

if (AppConstants.platform == "win") {
  XPCOMUtils.defineLazyModuleGetter(this, "SubprocessImpl",
    "chrome://autocrypt/content/modules/enigmailprocess_win.jsm"); /* global SubprocessImpl: false */
}
else {
  XPCOMUtils.defineLazyModuleGetter(this, "SubprocessImpl",
    "chrome://autocrypt/content/modules/enigmailprocess_unix.jsm");
}
